package net.lldv.pydow.cosmetics.components.language;
...
public class Language {
    ...
    public static void init() {
        messages.clear();
        Cosmetics.getInstance().saveResource("messages.yml");
        Config m = new Config(Cosmetics.getInstance().getDataFolder() + "/messages.yml", Config.YAML);
